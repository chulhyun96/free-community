...
class LocalImageFormatterTest {
    ...
    void keepExistingImage() {
        String existingImages = toJson(List.of(BASE_PATH + "/image1.jpg", BASE_PATH + "/image2.jpg"));
    ...
    void addNewImageWhenNoExistingImages() {
        ...
        String expected = toJson(List.of(BASE_PATH + "/new1.jpg", BASE_PATH + "/new2.jpg"));
    ...
    void deleteAllAndAddNewImages() {
        ...
        List<String> existingImages = List.of(BASE_PATH + "/image1.jpg", BASE_PATH + "/image2.jpg");
    ...
    void deleteSomeAndAddNewImages() {
        ...
        String existingImages = toJson(List.of(BASE_PATH + "/image1.jpg", BASE_PATH + "/image2.jpg"));
        List<String> deletedImages = List.of(BASE_PATH + "/image1.jpg");
        //when
